...
/**
 * Represents a Trailing Stop Percent Order Stock Transaction
 * 
 * @author Steven Shaw
...
public class TrailingStopPercentTrade extends Trade implements Serializable {

	private Stock symbol;
	private int shares;
	private String orderType;
	private double price;
	private final String tradeType = "trailing stop percent";

	public TrailingStopPercentTrade(String orderType, Stock symbol, int shares) {
