...
/**
 * Represents a Limit Order Stock Transaction
 * 
 * @author Steven Shaw
...
public class LimitTrade extends Trade implements Serializable {

	private Stock symbol;
	private int shares;
	private String orderType;
	private double price;
	private final String tradeType = "limit";

	public LimitTrade(String orderType, Stock symbol, int shares) {
