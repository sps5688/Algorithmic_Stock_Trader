...
/**
 * Represents a Market On Close Order Stock Transaction
 * 
 * @author Steven Shaw
...
public class MarketOnCloseTrade extends Trade implements Serializable {

	private Stock symbol;
	private int shares;
	private String orderType;
	private double price;
	private final String tradeType = "market on close";

	public MarketOnCloseTrade(String orderType, Stock symbol, int shares) {
