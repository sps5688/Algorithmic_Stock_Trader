...
/**
 * Represents a Stop Order Stock Transaction
 * 
 * @author Steven Shaw
...
public class StopTrade extends Trade implements Serializable {

	private Stock symbol;
	private int shares;
	private String orderType;
	private double price;
	private final String tradeType = "stop";

	public StopTrade(String orderType, Stock symbol, int shares) {
