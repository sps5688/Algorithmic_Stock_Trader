...
/**
 * Represents a Stop Limit Order Stock Transaction
 * 
 * @author Steven Shaw
...
public class StopLimitTrade extends Trade implements Serializable {

	private Stock symbol;
	private int shares;
	private String orderType;
	private double price;
	private final String tradeType = "stop limit";

	public StopLimitTrade(String orderType, Stock symbol, int shares) {
