...
/**
 * Represents a Trailing Stop Dollar Order Stock Transaction
 * 
 * @author Steven Shaw
...
public class TrailingStopDollarTrade extends Trade implements Serializable {

	private Stock symbol;
	private int shares;
	private String orderType;
	private double price;
	private final String tradeType = "trailing stop dollar";

	public TrailingStopDollarTrade(String orderType, Stock symbol, int shares) {
